...
export const cvData: CvData = {
  basics: {
    name: "Patrik Dinh",
    title: "Full-stack Developer focused on internal systems, automation and reliable product tools",
  ...
  profile:
    "I build internal systems, workflow automation and practical tools for real business use. My background in finance and operations helps me design software around messy workflows, validation and the constraints of day-to-day production use. I am most useful in environments where software needs to support real operations, reduce manual work and stay reliable once people start depending on it. I care about practical systems, clear logic and whether the final solution actually holds up in everyday use.",
